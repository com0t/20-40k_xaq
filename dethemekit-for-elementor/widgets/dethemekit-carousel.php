...
class DethemeKit_Carousel extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'default'     => '',
				'description' => __( 'Used by De Carousel Navigation Wrapper (in Section) and De Carousel Navigation Item ( in column ) to target this element', 'dethemekit-addons-for-elementor' ),
			)
		);
	...
	protected function render() {
		...
		$center_mode = 'yes' === $settings['dethemekit_carousel_center_mode'] ? true : false;
